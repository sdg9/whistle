        ...
        <div onChange={this.onNetworkSettingsChange} className="modal-body">
          ...
          <fieldset className="network-settings-columns">
            <legend>
              <label>
                <input
                  checked={!disabledColumns}
                  data-name="networkColumns"
                  type="checkbox"
                />
                Network Columns
              </label>
              <label onClick={this.resetColumns} className="btn btn-default">
                Reset
              </label>
            </legend>
          ...
          <label className="w-network-settings-own">
            <input
              ...
              type="checkbox"
            />
            Only take this machine's request into consideration (IP:{" "}
            {dataCenter.clientIp})
          </label>
        </div>
